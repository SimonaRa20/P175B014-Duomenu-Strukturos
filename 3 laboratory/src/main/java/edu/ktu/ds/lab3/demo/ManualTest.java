...
public class ManualTest {
    ...
    public static void executeTest() {
        ...
        testHashMapClass(carsIds, cars);
        testHashMapOaClass(carsIds,cars);
//        executeCarMapTests(carsIds, cars);
//        executeCarMapOaTests(carsIds, cars);
    }

    private static void testHashMapOaClass(String []  carsIds, Car[] cars){
        ParsableMap<String, Car> carsList
        ...
        for (int id = 0; id < cars.length; id++) {
            carsList.put(carsIds[id], cars[id]);
        }

        Ks.oun("HashMapOa klases testavimas");

        Ks.oun("List'as");
        carsList.println("=");

        carsList.remove("TA156");
        Ks.oun("Pasalintas pirmas elementas TA156");
        carsList.println("=");

        Car car = new Car("Honda   Civic  2007  36400 8500.3");
        Ks.oun("Tikrinu ar sarase yra tokia reiksme");
        if(carsList.containsValue(car) == true){
            Ks.oun("Yra tokia reiksme");
        }
        else{
            Ks.oun("Nera tokios reiksmes");
        }

        Ks.oun("Tikrinamas replace metodas");
        Car car1 = new Car("Renault", "Megane", 2001, 20000, 3500);
        Car car2 = new Car("Honda   Civic  2007  36400 8500.3");
        Car car3 = new Car("Toyota", "Corolla", 2001, 20000, 8500.8);
        Car car6 = new Car("Honda   Civic  2007  36400 8500.3");
        if(carsList.replace("TA156", car1, car2) == true){
            Ks.oun("Buvo pakeista reiksme");
        }
        else{
            Ks.oun("Nebuvo pakeista reiksme,nes nestiko rakto reiksme");
        }
        Ks.ounn(carsList);
    }

    private static void testHashMapClass(String []  carsIds, Car[] cars)
    {
        ParsableMap<String, Car> carsList
        ...
        Ks.oun("HashMap klases testavimas");
        ...
        Car car1 = new Car("Renault", "Megane", 2001, 20000, 3500);
        Car car2 = new Car("Honda   Civic  2007  36400 8500.3");
        if(carsList.replace("TA102", car1,car2) == true){
            Ks.oun("Buvo pakeista reiksme");
        }
        else{
            Ks.oun("Nebuvo pakeista reiksme,nes nestiko rakto reiksme");
        ...
        int l = carsList.averageChainSize();
        Ks.oun("average");
        Ks.oun(l);
        carsList.println("=");
    }
